...
namespace KPlugin.AppLovinMax.Editor
{
    ...
    [CustomEditor(typeof(AppLovinMaxBanner))]
    public class AppLovinMaxBannerEditor : UnityEditor.Editor
    {
        #region Properties
        ...
        private void OnEnable()
        {
            ...
            propertyCustomBackgroundColor = serializedObject.FindProperty("customBackgroundColor");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.EndDisabledGroup();
            //
            EditorGUILayout.PropertyField(propertyCustomBackgroundColor, new GUIContent("Custom Background Color"));
            if (propertyCustomBackgroundColor.boolValue)
